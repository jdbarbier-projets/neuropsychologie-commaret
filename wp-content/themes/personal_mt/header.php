    ...
    <?php endif; ?>
		...
		<div class="site-branding">
			...
			<div class="address">
				...
				Centre Thérapeutique <strong>"Sur un nuage"</strong><br />
				66 cours Napoléon<br />
				20000 <strong>AJACCIO</strong>
			</div>
			
			<div class="spacer"></div>
			
			<div class="phone">
				<a href="tel:0681433098"><i class="fa fa-phone fa-2x" aria-hidden="true"></i>Tél : 06 81 43 30 98</a>
			</div>
